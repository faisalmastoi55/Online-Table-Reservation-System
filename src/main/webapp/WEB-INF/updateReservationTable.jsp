	...
	<div id="wrapper" class="container">
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li><a href="home.jsp"><i class="fa fa-home"></i> Go Back
							to Homepage</a></li>
				</ul>
			</div>
		</nav>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header" align="center">Update RESERVATION</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-5 col-sm-5">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<form action="/updateBookedTable" method="post">
								<input type="hidden" name="id" value="${data.id}">
									...
									<div class="form-group">
										<label>Nationality*</label> <label class="radio-inline">
											<input type="radio" name="nation" required="required" value="Zimbabwe">Zimbabwe
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label>Time</label> <input name="tme" type="time"
											class="form-control" value="${data.tme}">
									</div>
									<div class="form-group">
										<label>Date</label> <input name="dte" type="date"
											class="form-control" value="${data.dte}">
									</div>
